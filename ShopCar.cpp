...
#include<sstream>
using namespace std;
ShopCar::ShopCar(int _num,string _name,char _class,string _email,Time _Start,int _ShopCar,int _ConsumeNum,Time _start,Time _end):Consume(_num,_name,_class,_email,_Start)
{
